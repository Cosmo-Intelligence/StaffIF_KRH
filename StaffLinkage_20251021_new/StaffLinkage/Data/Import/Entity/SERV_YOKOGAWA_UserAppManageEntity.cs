...
{
    /// <summary>
    /// 【SERV】YOKOGAWA.USERAPPMANAGE:ユーザアプリケーション管理
    /// </summary>
    class SERV_YOKOGAWA_UserAppManageEntity
    {
        #region const
        ...
        /// テーブル物理名：論理名
        /// </summary>
        public const string EntityName = "【SERV】YOKOGAWA.USERAPPMANAGE:ユーザアプリケーション管理";

        /// <summary>
        /// テーブル物理名
        /// </summary>
        public const string Entity = "YOKOGAWA.USERAPPMANAGE";
