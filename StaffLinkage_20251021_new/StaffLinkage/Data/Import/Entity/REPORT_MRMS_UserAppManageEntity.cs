...
{
    /// <summary>
    /// 【REPORT】MRMS.USERAPPMANAGE:ユーザアプリケーション管理
    /// </summary>
    class REPORT_MRMS_UserAppManageEntity
    {
        #region const
        ...
        /// テーブル物理名：論理名
        /// </summary>
        public const string EntityName = "【REPORT】MRMS.USERAPPMANAGE:ユーザアプリケーション管理";

        /// <summary>
        /// テーブル物理名
        /// </summary>
        public const string Entity = "MRMS.USERAPPMANAGE";
